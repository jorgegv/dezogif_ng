...
Save to `/home/jorgegv/.claude/projects/-home-jorgegv-src-spectrum-dezogif-ng/memory/project_session_handover_<YYYY-MM-DD><suffix>.md`. Suffix is `_eod`, `b_eod`, `c_eod`… by count for the day. Frontmatter:
